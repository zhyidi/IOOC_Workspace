...
{
    /// <summary>
    /// DoctorInformationManageWindow.xaml 的交互逻辑
    /// </summary>
    public partial class DoctorInformationManageWindow : Window
    {
        public DoctorInformationManageWindow()
        {
            InitializeComponent();
        ...
        {
            string sql = "select_table#select * from doctor";
            ...
            while (true)
            {
                if (Communication.receiveMsg != null)
                {
                    ...
                    datagrid_doctor.ItemsSource = dt.DefaultView;
