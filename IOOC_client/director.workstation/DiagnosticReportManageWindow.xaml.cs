...
{
    /// <summary>
    /// DiagnosticReportManageWindow.xaml 的交互逻辑
    /// </summary>
    public partial class DiagnosticReportManageWindow : Window
    {
        public DiagnosticReportManageWindow()
        {
            InitializeComponent();
        ...
        {
            string sql = "select_table#select DiagnosisID,PatientID,Satisfaction,Report_Doctor,Date,Check_State from diagnosis";
            ...
            while (true)
            {
                if (Communication.receiveMsg != null)
                {
                    ...
                    datagrid_diag.ItemsSource = dt.DefaultView;
        ...
        private void datagrid_diag_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
