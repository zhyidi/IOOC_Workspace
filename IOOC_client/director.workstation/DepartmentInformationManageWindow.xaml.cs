...
{
    /// <summary>
    /// DepartmentInformationManageWindow.xaml 的交互逻辑
    /// </summary>
    public partial class DepartmentInformationManageWindow : Window
    {
        public DepartmentInformationManageWindow()
        {
            InitializeComponent();
        ...
        {
            string sql = "select_table#select * from department";
            ...
            while (true)
            {
                if (Communication.receiveMsg != null)
                {
                    ...
                    datagrid_department.ItemsSource = dt.DefaultView;
